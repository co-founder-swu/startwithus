    ...
    <div className="absolute inset-0 flex flex-col justify-end p-2 lg:p-10">
            ...
            <div className="p-0.25 rounded-[2.5rem] bg-conic-gradient">
              <div className="relative p-8 bg-n-8 rounded-[2.4375rem] overflow-hidden xl:p-15">
                ...
                <div className="relative z-1">
                  <div className="mb-10 lg:-my-40 lg:-mx-15 sm:cover">
                    <img
                      className="w-full"
                      src={roadmap3}
                      alt="Roadmap 3"
      ...
      <div className="relative z-1 grid gap-8 lg:grid-cols-2">
        <div className="p-4 bg-back rounded-3xl overflow-hidden lg:min-h-[46rem]">
          ...
          <div className="py-14 px-4 xl:px-8">
            <h4 className="h4 pt-15 mb-4">
              Great stories often begin by addressing gaps and loopholes, leading to innovation fueled by passion and built on a foundation of accumulated knowledge.
            </h4>
            <p className="body-2 -mb-6 text-n-3">
