    ...
    <Section className="-mt-[5.25rem] relative">
      <div className="flex flex-col md:flex-row z-2 relative">
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="w-full md:w-1/2 rounded-2xl md:ml-10 mb-2 md:mb-0 bg-gradient-to-l from-n-8/0 to-n-8/90 p-6 z-10"
        >
          <h3 id="title" className="font-poppins text-white font-semibold h3 mb-2">
            Contact Us
          </h3>
          <div className="text-n-2 italic mb-2">
            Ready to elevate your business? Contact Start With Us today!
          </div>
          <form
            ref={formRef}
            onSubmit={handleSubmit}
            className="mt-2 flex flex-col gap-2 md:gap-8 z-10"
          >
